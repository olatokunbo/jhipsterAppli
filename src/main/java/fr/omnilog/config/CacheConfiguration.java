...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.omnilog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.omnilog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, fr.omnilog.domain.Valeur.class.getName() + ".valeurParents");
