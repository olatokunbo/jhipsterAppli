...
describe('UniteAdministrative Management Component', () => {
  let comp: UniteAdministrativeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'unite-administrative', component: UniteAdministrativeComponent }]),
      ...
      .overrideTemplate(UniteAdministrativeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.uniteAdministratives?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to uniteAdministrativeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUniteAdministrativeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUniteAdministrativeIdentifier).toHaveBeenCalledWith(entity);
